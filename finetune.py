...
parser.add_argument('--datatype', default='2015',
                    help='datapath')
parser.add_argument('--datapath', default='/data/PSM_dataset/KITTI_2015/',
                    help='datapath')
parser.add_argument('--epochs', type=int, default=400,
                    help='number of epochs to train')
parser.add_argument('--loadmodel', default='./trained/KITTI_2015/pretrained_model_KITTI2015.tar',
                    help='load model')
parser.add_argument('--savemodel', default='./trained/KITTI_2015/stackhourglass/',
                    help='save model')
