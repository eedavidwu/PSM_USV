...
parser.add_argument('--model', default='stackhourglass',
                    help='select model')
parser.add_argument('--datapath', default='/data/PSM_dataset/train/',
                    help='datapath')
parser.add_argument('--epochs', type=int, default=500,
                    help='number of epochs to train')
parser.add_argument('--loadmodel', default='./trained/stackhourglass/pretrained_sceneflow.tar', help='load model')

#parser.add_argument('--loadmodel', default=None, help='load model')

parser.add_argument('--savemodel', default='./trained/stackhourglass/', help='save model')
#parser.add_argument('--savemodel', default='./trained/basic/', help='save model')
